...
<p></p><p></p>
				...
				<table width="98%" border="1" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto;font-size: 12;'>
					...
					<tr>
						<td style='text-transform: uppercase;border:hidden;text-align:center;font-weight:bold;padding-bottom:  30px;' colspan='9'>Program Studi <?php echo $_POST['program_studi'] ?>  </td>
					</tr>
					<tr>
				...
				<tr></tr>
			<tr>
					<td style='border-right:hidden;border-left:hidden;' colspan='9'><b>Jumlah Alumni : Program Studi <?php echo $_POST['program_studi'] ?> = <?php echo $data1; ?></b></td>
				</tr>
				<tr>
					<td style='border-right:hidden;border-left:hidden;text-align:center' colspan='9'></td>
				</tr> 
				<!-- <tr>
					<td style='border:hidden' colspan='9'>Semoga Tuhan Yang Maha Esa Merahmati Kita Semua, Amin.</td>
				</tr> -->

<tr>
	<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left" style="margin-top: 20px;"></td>
...
<tr>
<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left" style="margin-top: -10px;"></div></td>
...
<tr><td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div></td>
<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div></td>
</tr>
<tr><td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div>&nbsp;</td>
<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div></td></tr>
<tr><td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div>&nbsp;</td>
<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div></td></tr>
<tr><td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div>&nbsp;</td>
<td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"></div></td></tr>
<tr><td style='border:hidden;text-align:center;font-weight:bold' colspan='5'><div align="left"><b><u>
	<?php
