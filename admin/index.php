  ...
  <section class="content">
    <div class="row">
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-aqua">
          ...
          <div class="info-box-content">
           <?php
           $result = $koneksi->query("SELECT * FROM alumni_profil INNER JOIN user ON user.id_user = alumni_profil.id_user WHERE active = '1'");
     ...
     <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-green">
        ...
        <div class="info-box-content">
          <?php
          $result = $koneksi->query("SELECT * FROM alumni_profil INNER JOIN user ON user.id_user = alumni_profil.id_user WHERE active = '0'");
          $data = mysqli_num_rows($result);
          ?>
          <span class="info-box-text">Alumni Belum Aktif</span>
          <span class="info-box-number"><?php echo $data; ?></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box bg-yellow">
        ...
        <div class="info-box-content">
          <?php
          $result = $koneksi->query("SELECT * FROM alumni_profil INNER JOIN user ON user.id_user = alumni_profil.id_user WHERE level = 'user'");
          $data = mysqli_num_rows($result);
          ?>
          <span class="info-box-text">Total Jumlah Alumni</span>
          <span class="info-box-number"><?php echo $data; ?></span>
          <h6>Jumlah Alumni</h6>
        </div>
        <!-- /.info-box-content -->
