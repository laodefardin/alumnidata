...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><h3 style="margin-bottom: -15px;"><strong>KEMENTERIAN RISET, TEKNOLOGI DAN PENDIDIKAN TINGGI</strong></h3></td>
	</tr>
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><h3 style="margin-bottom: -15px;"><strong>UNIVERSITAS NEGERI MAKASSAR (UNM)</strong></h3></td>
	</tr>
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><h3 style="margin-bottom: -15px;"><strong>FAKULTAS TEKNIK</strong></h3></td>
	</tr>
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><h3 style="margin-bottom: -15px;"><strong>JURUSAN PENDIDIKAN TEKNIK ELEKTRO</strong></h3></td>
	</tr>
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><h5 style="margin-bottom: -15px;"><strong>Alamat : Jl. Dg. Tata Raya Parang Tambung Makassar 90224 Telp : (0411) 861935-861507</strong></h5></td>
	</tr>
	<p></p>
	<tr>
	...
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'>YANG TELAH BEKERJA</td>
	</tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
	...
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='14'><div align="left">Makassar, <?php echo tgl_indo(date("Y-m-d")); ?></div></td>
	</tr>
