		...
		<tbody><tr>
			...
			<table width="98%">
				...
				<table width="98%" border="1" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
					...
					<tr>
						<td style='text-transform: uppercase;border:hidden;text-align:center;font-weight:bold;padding-bottom:  30px;' colspan='8'>Program Studi <?php echo $_POST['program_studi'] ?>  </td>
					</tr>
					<tr>
				...
				<tr>
					<td style='border-right:hidden;border-left:hidden;text-align:center;' colspan='8'><b>Jumlah Alumni :</b> Program Studi <?php echo $_POST['program_studi'] ?> = <?php echo $data1; ?></td>
				</tr>
				<tr>
