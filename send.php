...
$email_pengirim = 'alumnipascasarjanaunm@gmail.com'; // Isikan dengan email pengirim

$nama_pengirim = $_POST['nama']; // Isikan dengan nama pengirim
$telp = $_POST['telp']; // Isikan dengan nama pengirim
$nim = $_POST['nim']; // Isikan dengan nama pengirim
$usermail = $_POST['usermail'];
$subjek = 'Pertanyaan - '.$_POST['nama']; // Ambil subjek dari inputan form
$pesan = $_POST['pesan']; // Ambil pesan dari inputan form

$email_penerima = 'alumnipascasarjanaunm@gmail.com'; // Ambil email penerima dari inputan form
...
$mail->Password = 'alumnipasca123'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
