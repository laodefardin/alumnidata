...
<div class="content-wrapper" style="min-height: 901px;">
  ...
  <section class="content-header">
    <h1>
      Manage Pesan dan Kesan Anda
      <small>Pengaturan Pesan dan Kesan Anda</small>
    </h1>
  </section>
  ...
  <section class="content">
    ...
    <div class="box box-warning">
      <div class="box-header">
        ...
        <br>
        <button type="submit" name="submit" class="btn btn-success" onclick="window.location='tambah-pesan-kesan'">Tambah Pesan dan Kesan Anda</button>
      </div>
      ...
      <div class="box-body">
       ...
       <?php
       $result = $koneksi->query("SELECT * FROM data_pesankesan WHERE penulis='".$_SESSION['nm_lengkap']."'");
      ...
      <td><a href="hapus-pesankesan.php?id=<?php echo $data['id_pesankesan'];?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-danger btn-sm"">Hapus</a>
        <a href="edit-pesan-kesan.php?id=<?php echo $data['id_pesankesan'];?>" class="btn btn-primary btn-sm"">Edit</a>
      </td>
    </tr>
  <?php endforeach; ?>
</table>
