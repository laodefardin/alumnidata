        ...
        <form method="post" action="" class="form-horizontal" enctype="multipart/from-data">
          <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="table">
            <tr>
              ...
              <td>:</td>
              <td>
                <textarea name="pesan" class="form-control" rows="3" placeholder="Masukkan pesan anda"></textarea>
              </td>
              <tr>
                <tr>
                  <td>Kesan</td>
                  <td>:</td>
                  <td>
                    <textarea name="kesan" class="form-control" rows="3" placeholder="Masukkan kesan anda"></textarea>
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
