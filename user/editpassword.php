        ...
        if($data->num_rows){
          ...
          if(strlen($password_baru) >= 8){
            ...
            if($password_baru == $konfirmasi_password){
              ...
              $update = $koneksi->query("UPDATE user SET password='$password_baru' WHERE id_user = '".$_SESSION['data_id']."'");
              if($update){
      ...
      <form method="post" action="" class="form-horizontal">
        <table border="0" cellpadding="10" cellspacing="0" width="500" align="center" class="table">
           <tr>
            <td>Username</td>
            <td>:</td>
            <td><input value="<?=$_SESSION['username']?>" class="form-control" disabled></td>
            </tr>
          <tr>
            <td>Password Lama</td>
            <td>:</td>
