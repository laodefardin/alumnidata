				...
				<div class="kotak">
					<form id="form">
						<div class="row" style="margin-bottom: 15px;">
							...
							<div class="col-lg-4">
								<input type="text" readonly="true" class="form-control" id="nmMahasiswa" value="<?=$_POST['nmMahasiswa']?>">
							</div>
						</div>
		...
		<?php }elseif($statusAlumni==='Lanjut Studi'){?>
			<div id="kotak">
				<div class="row" style="margin-bottom: 15px;">
					...
					<span class="col-lg-2">Nama Lengkap</span>
					<div class="col-lg-4">
						<input type="text" readonly="true" class="form-control" id="nmMahasiswa" value="<?php echo $_POST['nmMahasiswa']; ?>">
					</div>
				</div>
				<div class="row" style="margin-bottom: 15px;">
